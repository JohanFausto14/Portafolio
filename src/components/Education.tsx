...
const Education = () => {
    ...
    return (
        <section id="education" className="py-20 bg-slate-950 min-h-screen flex items-center">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                ...
                >
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">{t.education?.title || 'Education'}</h2>
                                ...
                                {edu.achievements && edu.achievements.length > 0 && (
                                    <ul className="space-y-3 mt-4 pt-5 border-t border-slate-700/50">
                                        {edu.achievements.map((achievement: string, idx: number) => (
                                            <li key={idx} className="flex items-start text-base md:text-lg text-gray-200">
